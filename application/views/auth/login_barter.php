        ...
        <div class="bg-white rounded-xl shadow-2xl flex w-3/4 max-w-4xl flex-col md:flex-row overflow-hidden">
            <div class="w-full md:w-3/5 p-5">
                ...
                <div class="py-5 md:py-10 text-center">
                    <h2 class="text-xl lg:text-2xl font-bold text-gray-500 mb-2">Masuk Ke Akun Anda</h2>
                        ...
                        <div class="flex flex-col items-center">
                            <div class="mb-4 w-3/4 max-w-md">
                                <input type="email" name="email" placeholder="Email" autocomplete="off"
                                    class="w-full max-w-md border border-slate-400 rounded-full px-4 py-2 text-xs font-semibold bg-slate-100 focus:border-gray-500 focus:bg-white focus:outline-none" required>
                            </div>
                            ...
                            <button type="submit" name="login"
                                    class="rounded-full py-1 px-4 inline-block font-semibold border-2 border-gray-500 text-black transition hover:border-2 hover:border-gray-400 hover:bg-white hover:text-gray-500 mx-auto mt-4">
                                Login
                            </button>
                        </div>
                    </form>
            ...
            <div class="w-full md:w-2/5 bg-gray-500 text-white py-10 px md:py-16 text-center">
                <h2 class="text-xl lg:text-2xl font-bold mb-2">Hallo Pengguna</h2>
                <div class="border-2 w-10 border-white inline-block mb-2"></div>
                <p class="mb-4">Belum Punya Akun?</p>
                <p class="mb-8">Jika Anda Belum 
                    Punya Akun Silahkan Langsung Lakukan
                    Registrasi Terlebih Dahulu
                </p>
                <a href="<?php echo base_url('auth/register_user_barter'); ?>" 
