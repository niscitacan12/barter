            ...
            <div class="position-sticky">
                <div class="list-group mx-3 mt-4 default-color">
                    ...
                    <a href="" class="text-light">
                        <i class="fa-solid fa-address-card fa-fw fa-lg me-3"></i><span>Absen</span>
                    </a>
                    <hr class="text-light">
                    <a href="" class="text-light">
                        <i class="fa-solid fa-address-card fa-fw fa-lg me-3"></i><span>Izin</span>
                    </a>
                    <hr class="text-light">
                    <a href="" class="text-light">
                        <i class="fa-solid fa-clock-rotate-left fa-fw fa-lg me-3"></i><span>History</span>
                    </a>
                </div>
            </div>
        </nav>
