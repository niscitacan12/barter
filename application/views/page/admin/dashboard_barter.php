    ...
    <div class="p-4 sm:ml-64">
        <div class="p-5 mt-10 container mx-auto">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-5">
                <a href="<?= base_url('admin/user_barter'); ?>" class="w-full p-3 flex px-3 py-5 justify-between items-center rounded-xl bg-blue-400 border border-blue-200 rounded-lg shadow sm:p-8 dark:bg-blue-500 dark:border-blue-400">
                    <h5 class="text-white font-bold text-left">Data User</h5>
                    <div>
                ...
                <a href="<?= base_url('') ?>" class="w-full p-3 flex px-3 py-5 justify-between items-center rounded-xl bg-blue-400 border border-blue-200 rounded-lg shadow sm:p-8 dark:bg-blue-500 dark:border-blue-400">
                    <h5 class="text-white font-bold text-left">Barang Masuk</h5>
                    <div>
