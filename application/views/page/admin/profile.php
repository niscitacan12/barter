        ...
        <div class="bg-white rounded-lg shadow-md p-4">
            ...
            <form action="#" method="post" enctype="multipart/form-data">
                ...
                <div class="mb-4">
                    ...
                    <input type="password" class="border rounded-md w-full p-2" id="password" name="password">
                </div>
                <button class="bg-gray-800 text-white px-4 py-2 rounded-md" type="submit">Save changes</button>
            </form>
        </div>
    </div>
</div>
