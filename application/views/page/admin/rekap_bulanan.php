            ...
            <div class="w-full p-4 text-center bg-white border border-gray-200 rounded-lg shadow sm:p-8 dark:bg-gray-800 dark:border-gray-700">
                ...
                <form action="<?= base_url('admin/rekapPerBulan'); ?>" method="get">
                        <div class="flex justify-between items-center">
                            <select id="bulan" name="bulan" class="w-35 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 ml-auto">
                            ...
                            <button type="submit" class="focus:outline-none text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-0.9 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">
                                <i class="fa-regular fa-floppy-disk fa-xl"></i>
                            </button>
                            <div class="flex justify-between items-center">
                            <button type="submit" name="submit" class="focus:outline-none text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-0.9 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800 ml-auto" 
                                formaction="<?php echo base_url('admin/export_bulanan')?>">
