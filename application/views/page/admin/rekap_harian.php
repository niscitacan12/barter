            ...
            <main id="content" class="flex-1 p-4 sm:p-6">
                <div class="bg-white rounded-lg shadow-md p-4">
                    ...
                    <form action="<?= base_url('admin/rekap_harian'); ?>" method="post" class="flex flex-col sm:flex-row justify-center items-center gap-4">
                        <input type="date" class="border p-2 rounded-md" id="tanggal" name="tanggal" value="<?= isset($_GET['tanggal']) ? $_GET['tanggal'] : ''; ?>">
                        <button type="submit" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded inline-block">Filter</button>
                        <a href="<?= base_url('Admin/export_rekap_harian'); ?>" class="exp bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded inline-block ml-auto">Export Data</a>
