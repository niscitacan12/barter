...
<body>
    ...
    <div class="p-2 sm:ml-64">
        ...
        <div class="p-4 text-center bg-gray-400 border border-gray-200 rounded-lg shadow sm:p-8 dark:bg-gray-800 dark:border-gray-700">
                <?php
                ...
                <p class="text-gray-600">Selamat datang di aplikasi Absensi, <?php echo getNamaHari($date); ?> <?php echo convDate($date); ?>, <?php echo $timeWIB; ?> WIB</p>
            </div>
        </div>
        <div class="p-2 mt-5">
