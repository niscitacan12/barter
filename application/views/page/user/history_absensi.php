            ...
            <div
                ...
                <div class="relative overflow-x-auto shadow-md sm:rounded-lg mt-5">
                    <div class="flex justify-between items-center p-4">
                        ...
                        <!-- Form Bulan -->
                        <form id="form-bulan" action="<?php echo base_url(''); ?>" method="get"
                            class="flex flex-col items-center gap-4 mx-10">
                        ...
                        <!-- Form Tanggal -->
                        <form id="form-tanggal" action="<?php echo base_url(''); ?>" method="get"
                            ...
                            <div class="relative flex items-center mx-3">
                                <input type="text" id="tanggal" name="tanggal"
                                    ...
                                    placeholder="Pilih Tanggal" min="<?= date('Y-m-d') ?>" max="<?= date('Y-m-d') ?>">
                                <label for="tanggal"
                        ...
                        <!-- Form Tahun -->
                        <form id="form-tahun" action="<?php echo base_url(''); ?>" method="get"
                            class="flex flex-col items-center gap-4">
                            <div class="relative flex items-center">
